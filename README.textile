...
There are others, I know, but this is how I like my apps to start out.  Based on the Authlogic sample app (http://github.com/binarylogic/authlogic_example), password_resets branch.

h2. What is included?

* Authentication (including password reset)
* Welcome page placeholder
* Static content placeholders (About, FAQ, Privacy)
* Contact Us form
